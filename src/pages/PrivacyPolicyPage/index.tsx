        ...
        <div className="page-container--inner">
          <div className="content">
            ...
            <div className="terms-section">
              ...
              <p>We collect information you provide directly to us, such as when you create an account, make a booking, or contact us for support. This may include:</p>
              <ul>
                <li>Personal information (name, email address, phone number)</li>
                <li>Student verification information (university enrollment details)</li>
            ...
            <div className="terms-section">
              ...
              <ul>
                <li>With accommodation providers to facilitate your bookings</li>
            ...
            <div className="terms-section">
              ...
              <p>We use cookies and similar tracking technologies to collect and use personal information about you. You can control cookies through your browser settings, but disabling cookies may affect the functionality of our service.</p>
            </div>
            ...
            <div className="terms-section">
              ...
              <p>Our service is not intended for children under 18 years of age. We do not knowingly collect personal information from children under 18. If you are a parent or guardian and believe your child has provided us with personal information, please contact us.</p>
            </div>
