            ...
            <div className="content">
                ...
                <div className="terms-section">
                    ...
                    <ul>
                        ...
                        <li>Ensuring your student status remains valid throughout your use of the service</li>
                    </ul>
                </div>
                ...
                <div className="terms-section">
                    ...
                    <ul>
                        ...
                        <li>You are responsible for any damages to the accommodation during your stay</li>
                    </ul>
                </div>

                <div className="terms-section">
                    <h2>5. Payment Terms</h2>
                    <p>Payment processing is handled securely through our platform:</p>
                    <ul>
                        <li>Payment is typically required at the time of booking confirmation</li>
                        <li>We accept major credit cards and digital payment methods</li>
                        <li>All transactions are processed in USD</li>
                        <li>Refunds are subject to the cancellation policy of the specific property</li>
                    </ul>
                </div>
